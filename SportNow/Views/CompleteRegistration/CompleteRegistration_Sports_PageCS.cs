...
{
    public class CompleteRegistration_Sports_PageCS : DefaultPage
	{
        ...
        public CompleteRegistration_Sports_PageCS()
		{
            this.initLayout();
		...
		async void confirmSportsButtonClicked(object sender, EventArgs e)
        {
            ...
            Debug.Print("member.socio_tipo AQUI = " + App.member.socio_tipo);
            Debug.Print("member.federado_tipo AQUI = " + App.member.federado_tipo);
